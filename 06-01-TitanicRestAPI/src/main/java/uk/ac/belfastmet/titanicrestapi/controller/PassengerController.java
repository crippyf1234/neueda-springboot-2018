...
import uk.ac.belfastmet.titanicrestapi.repositories.PassengerRepository;
...
public class PassengerController {
	...
	public Passenger getAllPassenger(@PathVariable("passengerId") Integer passengerId) {
	...
	public String postAllPassengers() {
		...
		return "Hello Passengers by post";
